...
import ShoppingProductTile from "@/components/shopping-view/ShoppingProductTile.jsx";
import { useNavigate } from "react-router-dom";
import { addToCart, fetchCartItems } from "@/store/shop/cart-slice";
import { useToast } from "@/hooks/use-toast";
import ProductDetailsDialog from "@/components/shopping-view/ShoppingProductDetail.jsx";
...
function ShoppingHome() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prevSlide) => (prevSlide + 1) % getFeatureImages.length);
    }, 15000);
      ...
      <div className="relative w-full h-[600px] overflow-hidden top-[70px]">
        ...
        <Button
          ...
          onClick={() =>
            setCurrentSlide(
              (prevSlide) =>
                (prevSlide - 1 + getFeatureImages.length) %
                getFeatureImages.length
            )
          }
        ...
        <Button
          ...
          onClick={() =>
            setCurrentSlide(
              (prevSlide) => (prevSlide + 1) % getFeatureImages.length
            )
          }
